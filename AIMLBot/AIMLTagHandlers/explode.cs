...
namespace AIMLBot.AIMLTagHandlers
{
    ...
    /// </summary>
    public class explode : Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        {
            if (this.templateNode.Name.ToLower() == "explode")
            {
                return ExplodeTagResult(this.templateNode.InnerText);
            }
            return string.Empty;
        }

        private string ExplodeTagResult(string explodetext)
        {
            if (string.IsNullOrEmpty(explodetext))
            {
                return string.Empty;
            }

            char[] a = explodetext.ToCharArray();
