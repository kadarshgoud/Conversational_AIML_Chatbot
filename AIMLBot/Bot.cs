    ...
    public class Bot
    {
        ...
        public string PathToAIML
        {
            get
            {
                ...
                return Settings.AIMLPath;
            }
        }

        /// <summary>
        /// The directory to look in for the custom AIML files
        /// </summary>
        public string PathToCustomAIML
        {
            get
            {
                //return Path.Combine(AppDomain.CurrentDomain.BaseDirectory, this.GlobalSettings.grabSetting("aimldirectory"));
                return Settings.CustomAIML;
            }
        }
        ...
        private void setup()
        {
            ...
            this.Graphmaster = new Utils.Node();
        }
        ...
        public void loadSettings()
        {
            ...
            //string path = Path.Combine("config", "Settings.xml");
            string path = Settings.ConfigPath + "Settings.xml";
        ...
        public void loadSettings(string pathToSettings)
        {
            ...
            {
                this.GlobalSettings.addSetting("name", "UNI-BOT");
            }
            if (!this.GlobalSettings.containsSettingCalled("botmaster"))
            {
                this.GlobalSettings.addSetting("botmaster", "Adarsh");
            }
            ...
            {
                this.GlobalSettings.addSetting("location", "Siegen, Germany");
            }
            ...
            {
                this.GlobalSettings.addSetting("timeout", "2000000000");
            }
            ...
            this.Person2Substitutions.loadSettings(Settings.ConfigPath + "Person2Substitutions.xml");
            this.PersonSubstitutions.loadSettings(Settings.ConfigPath + "PersonSubstitutions.xml");
            this.GenderSubstitutions.loadSettings(Settings.ConfigPath + "GenderSubstitutions.xml");
            this.DefaultPredicates.loadSettings(Settings.ConfigPath + "DefaultPredicates.xml");
            this.Substitutions.loadSettings(Settings.ConfigPath + "Substitutions.xml");

            // Grab the splitters for this bot
            this.loadSplitters(Settings.ConfigPath + "Splitters.xml");
        }
                ...
                if (object.Equals(null, tagHandler))
                {
                    switch (tagName)
                    {
                        ...
                        case "date":
                            ...
                            break;
                        case "explode":
                            tagHandler = new AIMLTagHandlers.explode(this, user, query, request, result, node);
                            break;
                        case "first":
                            tagHandler = new AIMLTagHandlers.first(this, user, query, request, result, node);
                            break;
                        case "formal":
                        ...
                        case "random":
                            ...
                            break;
                        case "bulletlist":
                            tagHandler = new AIMLTagHandlers.bulletlist(this, user, query, request, result, node);
                            break;
                        case "sentence":
                        ...
                        case "set":
                            ...
                            break;
                        case "searchimage":
                            tagHandler = new AIMLTagHandlers.searchimage(this, user, query, request, result, node);
                            break;
                        case "size":
                        ...
                        case "searchandlearn":
                            ...
                            break;
                        case "wikisearch":
                            tagHandler = new AIMLTagHandlers.wikisearch(this, user, query, request, result, node);
                            break;
                        case "news":
